...
'			Me.treeList1.ShowFilterPopupCheckedListBox += New DevExpress.XtraTreeList.FilterPopupCheckedListBoxEventHandler(Me.treeList1_ShowFilterPopupCheckedListBox);
			' 
			' colName
			' 
